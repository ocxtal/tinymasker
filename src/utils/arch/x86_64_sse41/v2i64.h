...
#define _max_v2i64(a, b) ( \
	(v2i64_t){ _mm_castpd_si128(_mm_blendv_pd( \
		_mm_castsi128_pd((a).v1), \
		_mm_castsi128_pd((b).v1), \
		_mm_castsi128_pd(_mm_sub_epi64((a).v1, (b).v1)) \
	))} \
)
#define _min_v2i64(a, b) ( \
	(v2i64_t){ _mm_castpd_si128(_mm_blendv_pd( \
		_mm_castsi128_pd((a).v1), \
		_mm_castsi128_pd((b).v1), \
		_mm_castsi128_pd(_mm_sub_epi64((b).v1, (a).v1)) \
	))} \
)
...
/* shift */
#define _sar_v2i64(a, n) ( \
	(v2i64_t) {_i_v2i64(srai)((a).v1, (n))} \
)
...
/* convert */
#define _cvt_v2i8_v2i64(a) ( \
	(v2i64_t) { _mm_cvtepi8_epi64(_mm_cvtsi64_si128(a)) } \
)
#define _cvt_v2i64_v2i8(a) ( \
	(uint16_t)_mm_cvtsi128_si64(_mm_shuffle_epi8((a).v1, _mm_cvtsi64_si128(0x0800))) \
)
...
/* transpose */
#define _lo_v2i64(b, a) ( \
	(v2i64_t) { \
		_mm_unpacklo_epi64((a).v1, (b).v1) \
	} \
)
#define _hi_v2i64(b, a) ( \
	(v2i64_t) { \

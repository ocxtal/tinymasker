...
#define _bsl_v16i16(a, imm) ( \
	(v16i16_t) { \
		_i_v16i16x(slli)((a).v1, 2 * (imm)), \
		_i_v16i16(alignr)((a).v2, (a).v1, sizeof(__m128i) - 2 * (imm)) \
	} \
)
#define _bsr_v16i16(a, imm) ( \
	(v16i16_t) { \
		_i_v16i16(alignr)((a).v2, (a).v1, 2 * (imm)), \
		_i_v16i16x(srli)((a).v2, 2 * (imm)) \
	} \
)
...
#define _bsld_v16i16(a, b, imm) ( \
	(v16i16_t) { \
		_i_v16i16(alignr)((a).v1, (b).v2, sizeof(__m128i) - 2 * (imm)), \
		_i_v16i16(alignr)((a).v2, (a).v1, sizeof(__m128i) - 2 * (imm)) \
	} \
)
#define _bsrd_v16i16(a, b, imm) ( \
	(v16i16_t) { \
		_i_v16i16(alignr)((b).v2, (b).v1, 2 * (imm)), \
		_i_v16i16(alignr)((a).v1, (b).v2, 2 * (imm)) \
	} \
)

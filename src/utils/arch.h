...
#  if defined(__AVX2__)
#    include "arch/x86_64_avx2/arch_util.h"
#    include "arch/x86_64_avx2/vector.h"
#  elif defined(__SSE4_1__)
#    include "arch/x86_64_sse41/arch_util.h"
#    include "arch/x86_64_sse41/vector.h"
...
/* page size */
#define ARCH_PAGE_SIZE			( 4ULL * 1024 )
#define ARCH_HUGEPAGE_SIZE		( 2ULL * 1024 * 1024 )			/* fixme */
...
#ifdef AARCH64
#  error "missing constant definitions for AARCH64"

#endif

#ifdef PPC64
#  error "missing constant definitions for PPC64"
